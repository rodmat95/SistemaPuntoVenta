...
public class InterHistorialCategoria extends javax.swing.JInternalFrame {

    private CategoriaController categoriaController = new CategoriaController();
    
    public InterHistorialCategoria() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Historial de Categorias");
        ...
        lblTitulo.setText("Historial Categorias");
        ...
        lblTituloCreaccion.setText("Registro de Categorias Creadas");
        ...
        tblCreaccion.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Descripcion", "Estado", "Fecha", "Hora"
            }
        ) {
        ...
        lblTituloActualizacion.setText("Registro de Categorias Actualizadas");
    ...
    private void llenarTBLCreaccion() {
        ...
        for (Categoria categoria : listaCategorias) {
            ...
            Timestamp creadoEn = categoria.getCreado_en();
    ...
    private void llenarTBLActualizacion() {
        ...
        for (Categoria categoria : listaCategorias) {
            String estadoTexto = (categoria.getEstado() == 1) ? "Activo" : "Inactivo";
            Timestamp actualizadoEn = categoria.getActualizado_en();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        filtrarPorFecha(tblCreaccion, fechaSeleccionada, 4);
        filtrarPorFecha(tblActualizacion, fechaSeleccionada, 4);
    ...
    private void btnCExelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCExelActionPerformed
        ...
        exportToExcel(tblCreaccion, descargasDirectory + "\\Categorias_creaccion.xlsx");
    ...
    private void btnAExelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAExelActionPerformed
        String descargasDirectory = System.getProperty("user.home") + "\\Downloads";
        exportToExcel(tblActualizacion, descargasDirectory + "\\Categorias_actualizacion.xlsx");
